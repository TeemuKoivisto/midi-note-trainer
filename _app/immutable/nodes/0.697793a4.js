import{S as O,i as S,s as A,O as N,e as v,B as R,J as q,n as C,a as g,b as k,C as J,K as H,d as u,p as z,o as X,f as y,g as E,h as m,L as D,q as U,U as Q,t as _,l as I,M as x,x as P,F as V,y as K,P as B,I as Y,V as L,W as T,X as W,Y as F,c as Z,u as ee,j as te,k as se}from"../chunks/vendor_svelte.4ac28885.js";import{b as ae}from"../chunks/vendor.e74270f4.js";import{o as ie,m as oe,a as ne}from"../chunks/modal.3af002c9.js";/* empty css                         */const le=!0,we=Object.freeze(Object.defineProperty({__proto__:null,prerender:le},Symbol.toStringTag,{value:"Module"}));function re(l){let s,i,e,o,t,a,n,c,b=`<p class="svelte-cjiik9">Greetings! 👋</p> <p class="svelte-cjiik9">This is a tiny app that I made to help myself and hopefully others to learn music notation. I
      ...
      is a <code class="svelte-cjiik9">sus</code> chord with no fifth in which case I add one. Which makes the triad not diatonic
      so uhh... I&#39;d love to hear opinions about this.</p> <p class="svelte-cjiik9">Clicking the notes or the triads will play them in the chosen key (or whatever is used in
      ...
      could add 5 flats to the signature and then naturalize the As but that starts to get convoluted.</p> <h3 class="svelte-cjiik9">Play</h3> <p class="svelte-cjiik9">This is the meat of the app. There&#39;s a list of games you can play to practise your skills with
      the intention of adding a few more in the years to come. I hope they are quite
      self-explanatory as I haven&#39;t written down any instructions for any of them. <b>Guess Pitches</b> game is relatively useless for those who have no chance of acquiring perfect pitch but it&#39;s fun
      to try once in a while.</p> <p class="svelte-cjiik9">In the base settings, I am by default enabling <b>Duplicates</b> as well as <b>Autoplay</b>
      ...
      another. As well as recognizing the played scales. Oh well. Pull requests are welcome!</p> <p class="svelte-cjiik9">As an end note, I hope this app will be helpful in learning music notation! I found multiple
      ...
      sheets doesn&#39;t require pulling my hair while deciphering them 😄.</p>`,w,j,p;return a=new N({props:{icon:ae,width:24}}),{c(){s=v("div"),i=v("h2"),e=R(`Introduction
    `),o=v("div"),t=v("button"),q(a.$$.fragment),n=C(),c=v("article"),c.innerHTML=b,this.h()},l(h){s=g(h,"DIV",{class:!0});var r=k(s);i=g(r,"H2",{class:!0});var d=k(i);e=J(d,`Introduction
    `),o=g(d,"DIV",{class:!0});var f=k(o);t=g(f,"BUTTON",{class:!0});var $=k(t);H(a.$$.fragment,$),$.forEach(u),f.forEach(u),d.forEach(u),n=z(r),c=g(r,"ARTICLE",{class:!0,"data-svelte-h":!0}),X(c)!=="svelte-1e9184i"&&(c.innerHTML=b),r.forEach(u),this.h()},h(){y(t,"class","flex items-center text-sm rounded-full px-2 py-2 hover:bg-gray-200"),y(o,"class","absolute top-0 right-0"),y(i,"class","pl-1.5 mt-4 mb-2 text-5xl font-semibold text-black relative"),y(c,"class","w-full p-2 pb-4 svelte-cjiik9"),y(s,"class","flex flex-col")},m(h,r){E(h,s,r),m(s,i),m(i,e),m(i,o),m(o,t),D(a,t,null),m(s,n),m(s,c),w=!0,j||(p=U(t,"click",function(){Q(l[0])&&l[0].apply(this,arguments)}),j=!0)},p(h,[r]){l=h},i(h){w||(_(a.$$.fragment,h),w=!0)},o(h){I(a.$$.fragment,h),w=!1},d(h){h&&u(s),x(a),j=!1,p()}}}function ce(l,s,i){let{params:e}=s,{hideModal:o=()=>{}}=s;return l.$$set=t=>{"params"in t&&i(1,e=t.params),"hideModal"in t&&i(0,o=t.hideModal)},[o,e]}class he extends O{constructor(s){super(),S(this,s,ce,re,A,{params:1,hideModal:0})}}function G(l){let s,i,e,o,t,a,n,c,b,w,j;var p=l[2][l[0]];function h(r,d){return{props:{params:r[1][r[0]],hideModal:r[3]}}}return p&&(n=Y(p,h(l))),{c(){s=v("div"),i=v("button"),o=C(),t=v("div"),a=v("div"),n&&q(n.$$.fragment),this.h()},l(r){s=g(r,"DIV",{class:!0});var d=k(s);i=g(d,"BUTTON",{class:!0,tabindex:!0}),k(i).forEach(u),o=z(d),t=g(d,"DIV",{class:!0});var f=k(t);a=g(f,"DIV",{class:!0});var $=k(a);n&&H(n.$$.fragment,$),$.forEach(u),f.forEach(u),d.forEach(u),this.h()},h(){y(i,"class","fixed z-40 inset-0 h-full w-full bg-black bg-opacity-50 outline-none cursor-default"),y(i,"tabindex","-1"),y(a,"class","relative flex flex-col p-6 text-left bg-gray-100"),y(t,"class","absolute top-4 bottom-0 mb-4 z-50 bg-gray-100 w-11/12 mx-auto rounded-xl shadow-lg overflow-y-auto md:max-w-3xl"),y(s,"class","fixed z-40 w-full h-full top-0 left-0 flex items-center justify-center")},m(r,d){E(r,s,d),m(s,i),m(s,o),m(s,t),m(t,a),n&&D(n,a,null),b=!0,w||(j=U(i,"click",l[3]),w=!0)},p(r,d){if(l=r,d&1&&p!==(p=l[2][l[0]])){if(n){V();const f=n;I(f.$$.fragment,1,0,()=>{x(f,1)}),K()}p?(n=Y(p,h(l)),q(n.$$.fragment),_(n.$$.fragment,1),D(n,a,null)):n=null}else if(p){const f={};d&3&&(f.params=l[1][l[0]]),n.$set(f)}},i(r){b||(r&&L(()=>{b&&(e||(e=T(i,W,{duration:M},!0)),e.run(1))}),n&&_(n.$$.fragment,r),r&&L(()=>{b&&(c||(c=T(t,F,{duration:M},!0)),c.run(1))}),b=!0)},o(r){r&&(e||(e=T(i,W,{duration:M},!1)),e.run(0)),n&&I(n.$$.fragment,r),r&&(c||(c=T(t,F,{duration:M},!1)),c.run(0)),b=!1},d(r){r&&u(s),r&&e&&e.end(),n&&x(n),r&&c&&c.end(),w=!1,j()}}}function de(l){let s,i,e=l[0]&&G(l);return{c(){e&&e.c(),s=P()},l(o){e&&e.l(o),s=P()},m(o,t){e&&e.m(o,t),E(o,s,t),i=!0},p(o,[t]){o[0]?e?(e.p(o,t),t&1&&_(e,1)):(e=G(o),e.c(),_(e,1),e.m(s.parentNode,s)):e&&(V(),I(e,1,1,()=>{e=null}),K())},i(o){i||(_(e),i=!0)},o(o){I(e),i=!1},d(o){o&&u(s),e&&e.d(o)}}}const M=400;function ue(l,s,i){let e,o;B(l,ie,n=>i(0,e=n)),B(l,oe,n=>i(1,o=n));const t={introduction:he};function a(){ne.close()}return[e,o,t,a]}class fe extends O{constructor(s){super(),S(this,s,ue,de,A,{})}}function pe(l){let s,i,e;const o=l[1].default,t=Z(o,l,l[0],null);return i=new fe({}),{c(){t&&t.c(),s=C(),q(i.$$.fragment)},l(a){t&&t.l(a),s=z(a),H(i.$$.fragment,a)},m(a,n){t&&t.m(a,n),E(a,s,n),D(i,a,n),e=!0},p(a,[n]){t&&t.p&&(!e||n&1)&&ee(t,o,a,a[0],e?se(o,a[0],n,null):te(a[0]),null)},i(a){e||(_(t,a),_(i.$$.fragment,a),e=!0)},o(a){I(t,a),I(i.$$.fragment,a),e=!1},d(a){a&&u(s),t&&t.d(a),x(i,a)}}}function me(l,s,i){let{$$slots:e={},$$scope:o}=s;return l.$$set=t=>{"$$scope"in t&&i(0,o=t.$$scope)},[o,e]}class ke extends O{constructor(s){super(),S(this,s,me,pe,A,{})}}export{ke as component,we as universal};
