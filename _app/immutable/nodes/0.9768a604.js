import{S as O,i as S,s as C,O as K,e as v,G as R,a as M,b as A,g,h as w,H as J,d as H,j as u,f as z,x as Q,k as y,l as E,n as m,m as q,y as V,V as X,t as _,q as I,r as D,B,J as F,C as U,Q as P,N as Y,W as G,X as T,Y as W,Z as L,c as Z,u as ee,o as te,p as se}from"../chunks/vendor_svelte.66c9e08b.js";import{b as ae}from"../chunks/vendor.e9b0235c.js";import{o as ie,m as oe,a as ne}from"../chunks/modal.6acf4770.js";/* empty css                         */const le=!0,ke=Object.freeze(Object.defineProperty({__proto__:null,prerender:le},Symbol.toStringTag,{value:"Module"}));function re(l){let s,i,e,o,t,a,n,c,b=`<p class="svelte-cjiik9">Greetings! 👋</p> <p class="svelte-cjiik9">This is a tiny app that I made to help myself and hopefully others to learn music notation. I
      ...
      revisiting my old sheets doesn&#39;t require pulling (as much) hair to decipher them 😄.</p>`,k,j,p;return a=new K({props:{icon:ae,width:24}}),{c(){s=v("div"),i=v("h2"),e=R(`Introduction
    `),o=v("div"),t=v("button"),M(a.$$.fragment),n=A(),c=v("article"),c.innerHTML=b,this.h()},l(h){s=g(h,"DIV",{class:!0});var r=w(s);i=g(r,"H2",{class:!0});var d=w(i);e=J(d,`Introduction
    `),o=g(d,"DIV",{class:!0});var f=w(o);t=g(f,"BUTTON",{class:!0});var $=w(t);H(a.$$.fragment,$),$.forEach(u),f.forEach(u),d.forEach(u),n=z(r),c=g(r,"ARTICLE",{class:!0,"data-svelte-h":!0}),Q(c)!=="svelte-bhls3i"&&(c.innerHTML=b),r.forEach(u),this.h()},h(){y(t,"class","flex items-center text-sm rounded-full px-2 py-2 hover:bg-gray-200"),y(o,"class","absolute top-0 right-0"),y(i,"class","pl-1.5 mt-4 mb-2 text-5xl font-semibold text-black relative"),y(c,"class","w-full p-2 pb-4 svelte-cjiik9"),y(s,"class","flex flex-col")},m(h,r){E(h,s,r),m(s,i),m(i,e),m(i,o),m(o,t),q(a,t,null),m(s,n),m(s,c),k=!0,j||(p=V(t,"click",function(){X(l[0])&&l[0].apply(this,arguments)}),j=!0)},p(h,[r]){l=h},i(h){k||(_(a.$$.fragment,h),k=!0)},o(h){I(a.$$.fragment,h),k=!1},d(h){h&&u(s),D(a),j=!1,p()}}}function ce(l,s,i){let{params:e}=s,{hideModal:o=()=>{}}=s;return l.$$set=t=>{"params"in t&&i(1,e=t.params),"hideModal"in t&&i(0,o=t.hideModal)},[o,e]}class he extends O{constructor(s){super(),S(this,s,ce,re,C,{params:1,hideModal:0})}}function N(l){let s,i,e,o,t,a,n,c,b,k,j;var p=l[2][l[0]];function h(r,d){return{props:{params:r[1][r[0]],hideModal:r[3]}}}return p&&(n=Y(p,h(l))),{c(){s=v("div"),i=v("button"),o=A(),t=v("div"),a=v("div"),n&&M(n.$$.fragment),this.h()},l(r){s=g(r,"DIV",{class:!0});var d=w(s);i=g(d,"BUTTON",{class:!0,tabindex:!0}),w(i).forEach(u),o=z(d),t=g(d,"DIV",{class:!0});var f=w(t);a=g(f,"DIV",{class:!0});var $=w(a);n&&H(n.$$.fragment,$),$.forEach(u),f.forEach(u),d.forEach(u),this.h()},h(){y(i,"class","fixed z-40 inset-0 h-full w-full bg-black bg-opacity-50 outline-none cursor-default"),y(i,"tabindex","-1"),y(a,"class","relative flex flex-col p-6 text-left bg-gray-100"),y(t,"class","absolute top-4 bottom-0 mb-4 z-50 bg-gray-100 w-11/12 mx-auto rounded-xl shadow-lg overflow-y-auto md:max-w-3xl"),y(s,"class","fixed z-40 w-full h-full top-0 left-0 flex items-center justify-center")},m(r,d){E(r,s,d),m(s,i),m(s,o),m(s,t),m(t,a),n&&q(n,a,null),b=!0,k||(j=V(i,"click",l[3]),k=!0)},p(r,d){if(l=r,d&1&&p!==(p=l[2][l[0]])){if(n){F();const f=n;I(f.$$.fragment,1,0,()=>{D(f,1)}),U()}p?(n=Y(p,h(l)),M(n.$$.fragment),_(n.$$.fragment,1),q(n,a,null)):n=null}else if(p){const f={};d&3&&(f.params=l[1][l[0]]),n.$set(f)}},i(r){b||(r&&G(()=>{b&&(e||(e=T(i,W,{duration:x},!0)),e.run(1))}),n&&_(n.$$.fragment,r),r&&G(()=>{b&&(c||(c=T(t,L,{duration:x},!0)),c.run(1))}),b=!0)},o(r){r&&(e||(e=T(i,W,{duration:x},!1)),e.run(0)),n&&I(n.$$.fragment,r),r&&(c||(c=T(t,L,{duration:x},!1)),c.run(0)),b=!1},d(r){r&&u(s),r&&e&&e.end(),n&&D(n),r&&c&&c.end(),k=!1,j()}}}function de(l){let s,i,e=l[0]&&N(l);return{c(){e&&e.c(),s=B()},l(o){e&&e.l(o),s=B()},m(o,t){e&&e.m(o,t),E(o,s,t),i=!0},p(o,[t]){o[0]?e?(e.p(o,t),t&1&&_(e,1)):(e=N(o),e.c(),_(e,1),e.m(s.parentNode,s)):e&&(F(),I(e,1,1,()=>{e=null}),U())},i(o){i||(_(e),i=!0)},o(o){I(e),i=!1},d(o){o&&u(s),e&&e.d(o)}}}const x=400;function ue(l,s,i){let e,o;P(l,ie,n=>i(0,e=n)),P(l,oe,n=>i(1,o=n));const t={introduction:he};function a(){ne.close()}return[e,o,t,a]}class fe extends O{constructor(s){super(),S(this,s,ue,de,C,{})}}function pe(l){let s,i,e;const o=l[1].default,t=Z(o,l,l[0],null);return i=new fe({}),{c(){t&&t.c(),s=A(),M(i.$$.fragment)},l(a){t&&t.l(a),s=z(a),H(i.$$.fragment,a)},m(a,n){t&&t.m(a,n),E(a,s,n),q(i,a,n),e=!0},p(a,[n]){t&&t.p&&(!e||n&1)&&ee(t,o,a,a[0],e?se(o,a[0],n,null):te(a[0]),null)},i(a){e||(_(t,a),_(i.$$.fragment,a),e=!0)},o(a){I(t,a),I(i.$$.fragment,a),e=!1},d(a){a&&u(s),t&&t.d(a),D(i,a)}}}function me(l,s,i){let{$$slots:e={},$$scope:o}=s;return l.$$set=t=>{"$$scope"in t&&i(0,o=t.$$scope)},[o,e]}class we extends O{constructor(s){super(),S(this,s,me,pe,C,{})}}export{we as component,ke as universal};
