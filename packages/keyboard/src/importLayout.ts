...
export const LAYOUTS = {
  ...
  balochi: { name: 'Balochi', import: import('simple-keyboard-layouts/build/layouts/balochi') },
  ...
  gilaki: { name: 'Gilaki', import: import('simple-keyboard-layouts/build/layouts/gilaki') },
  ...
  odia: { name: 'Odia', import: import('simple-keyboard-layouts/build/layouts/odia') },
  ...
  ru2: { name: 'Russian Old', import: import('simple-keyboard-layouts/build/layouts/russianOld') },
