...
export const scales = {
  ...
  diminishedWholeHalf: {
    ...
    notes: ['1', '2', '♭3', '4', '♭5', '♭6', '6', '7']
  },
  diminishedHalfWhole: {
    name: 'Diminished Half-Whole',
    tones: [1, 2, 1, 2, 1, 2, 1, 2],
    notes: ['1', '♭2', '♭3', '♭4', '♭5', '5', '6', '♭7']
  },
  augmented: {
    name: 'Augmented',
    tones: [3, 1, 3, 1, 3, 1],
  ...
  // japanese
  hirojoshi: { name: 'Hirojoshi', tones: [2, 1, 4, 1, 4], notes: ['1', '2', '♭3', '5', '♭6'] },
  japaneseA: { name: 'Japanese A', tones: [1, 4, 1, 3, 3], notes: ['1', '♭2', '4', '♭5', '6'] },
  japaneseB: { name: 'Japanese B', tones: [2, 3, 1, 3, 3], notes: ['1', '2', '4', '♭5', '6'] },
  yo: { name: 'Yo', tones: [2, 3, 2, 2, 3], notes: ['1', '2', '4', '5', '6', '♭7'] },
  insen: { name: 'Insen', tones: [1, 4, 2, 3, 2], notes: ['1', '♭2', '4', '5', '♭7'] },
  iwato: { name: 'Iwato', tones: [1, 4, 1, 4, 2], notes: ['1', '♭2', '4', '♭5', '♭7'] },
  // other
  oriental: {
    name: 'Oriental',
    tones: [1, 3, 1, 1, 3, 1, 2],
  ...
  balinese: { name: 'Balinese', tones: [1, 2, 4, 1, 4], notes: ['1', '♭2', '♭3', '5', '♭6'] },
  kumoi: { name: 'Kumoi', tones: [2, 1, 4, 2, 2, 1], notes: ['1', '2', '♭3', '5', '6'] },
  pelog: { name: 'Pelog', tones: [1, 2, 3, 1, 1, 4], notes: ['1', '♭2', '♭3', '5', '♭6'] },
  algerian: {
    name: 'Algerian',
    tones: [2, 1, 2, 1, 1, 1, 3, 1],
    notes: ['1', '2', '♭3', '4', '♯4', '5', '♭6', '7']
  },
  chinese: { name: 'Chinese', tones: [4, 2, 1, 4, 1], notes: ['1', '♯4', '5', '7'] },
  mongolian: { name: 'Mongolian', tones: [2, 2, 3, 2, 3], notes: ['1', '2', '3', '5', '6'] },
