...
export const scales = {
  ...
  // modes
  ionian: [0, 2, 2, 1, 2, 2, 2], // == major
  aeolian: [0, 2, 1, 2, 2, 1, 2], // == minor
  dorian: [0, 2, 1, 2, 2, 2, 1],
  phrygian: [0, 1, 2, 2, 2, 1, 2],
  lydian: [0, 2, 2, 2, 1, 2, 2],
  lydianDominant: [0, 2, 2, 2, 1, 2, 1], // EQUAL
  acoustic: [0, 2, 2, 2, 1, 2, 1], // EQUAL
  ...
  minor7b5: [0, 2, 1, 2, 1, 2, 2], // EQUAL
  halfDiminished: [0, 2, 1, 2, 1, 2, 2], // EQUAL

  // harmonic
  harmonicMajor: [0, 2, 2, 1, 2, 1, 3],
  harmonicMinor: [0, 2, 1, 2, 2, 1, 3],
  doubleHarmonic: [0, 1, 3, 1, 2, 1, 3], // EQUAL
  byzantine: [0, 1, 3, 1, 2, 1, 3], // EQUAL
  ...
  spanish8Tone: [0, 1, 2, 1, 1, 1, 2, 2], // EQUAL
  jewish: [0, 1, 2, 1, 1, 1, 2, 2], // EQUAL
